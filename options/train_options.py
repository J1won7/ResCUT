...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_nifti_epoch_freq', type=int, default=0, help='save fixed full-volume NIfTI samples every N epochs; 0 disables')
        parser.add_argument('--nifti_sample_count', type=int, default=2, help='number of fixed test volumes saved at each NIfTI sample epoch')
        ...
        parser.add_argument('--pretrained_dir', type=str, default='', help='optional direct directory containing <epoch>_net_{G,D,F}.pth')
